...
/**
 * Sense EnoughDefenders for Yaposh.
 *
 * @author Marci
 ...
 * environment.
 */
@PrimitiveInfo(name = "EnoughDefenders", description = "Description of EnoughDefenders")
public class EnoughDefenders<CONTEXT extends CTFBotContext> extends ParamsSense<CONTEXT, Boolean> {
     ...
     * used by the sense.
     */
    public EnoughDefenders(CONTEXT ctx) {
    ...
    public Boolean query() {
        ...
        return ctx.otherDefendersCount > 0;
    }
}
