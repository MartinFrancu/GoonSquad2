 ...
 * @author Marci
 */
public class RoleRemoved extends TCMessageData{
    // if
    public UnrealId sendeId;
    public TeamRoles formerRole;
    public long time;

    public RoleRemoved(UnrealId sendeId, TeamRoles formerRole, long time) {
